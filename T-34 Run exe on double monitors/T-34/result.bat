...
:question
REM Задаем вопрос
set /p user_input=Введите другое значение если экраны при последнем запуске открывались наоборот (y/n) или пропустите ответ, чтобы продолжить без изменений:
